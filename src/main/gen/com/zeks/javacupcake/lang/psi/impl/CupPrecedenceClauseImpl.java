...
public class CupPrecedenceClauseImpl extends ASTWrapperPsiElement implements CupPrecedenceClause {

  public CupPrecedenceClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitPrecedenceClause(this);
  }
