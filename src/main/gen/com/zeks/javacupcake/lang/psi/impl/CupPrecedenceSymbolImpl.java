...
public class CupPrecedenceSymbolImpl extends ASTWrapperPsiElement implements CupPrecedenceSymbol {

  public CupPrecedenceSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitPrecedenceSymbol(this);
  }
