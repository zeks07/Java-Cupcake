...
public class CupNonTerminalAlternativeImpl extends ASTWrapperPsiElement implements CupNonTerminalAlternative {

  public CupNonTerminalAlternativeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitNonTerminalAlternative(this);
  }
