...
public class CupPackageSpecImpl extends ASTWrapperPsiElement implements CupPackageSpec {

  public CupPackageSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitPackageSpec(this);
  }
