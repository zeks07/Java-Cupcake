...
public class CupOptionalSemicolonImpl extends ASTWrapperPsiElement implements CupOptionalSemicolon {

  public CupOptionalSemicolonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitOptionalSemicolon(this);
  }
