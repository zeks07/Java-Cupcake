...
public class CupRightHandSideImpl extends ASTWrapperPsiElement implements CupRightHandSide {
  ...
  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitRightHandSide(this);
  }
  ...
  @Override
  @NotNull
  public List<CupCodeStringBlock> getCodeStringBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CupCodeStringBlock.class);
  }

  @Override
  @NotNull
  public List<CupLabel> getLabelList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CupLabel.class);
  }
  ...
  @Override
  @NotNull
  public List<CupSymbol> getSymbolList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CupSymbol.class);
  }
